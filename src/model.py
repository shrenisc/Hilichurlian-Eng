...
def apply_rotary_emb(input_tensor, C, T):
    ...
    freqs_real, freqs_imag = compute_freqs_cis(C, input_tensor.shape[-2], input_tensor.device)
...
class Decoder(nn.Module):
    ...
    def __init__(self, input_shape, output_shape, num_heads, dropout = 0):
        ...
        self.CA = CrossAttention(embed_dim=input_shape, num_heads=num_heads, bias = False, dropout=dropout)
